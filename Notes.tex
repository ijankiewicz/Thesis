...
\end{tabular}
\caption{Capacitors selected for the \textit{LC3588-1} circuit}
...
\end{tabular}
\caption{Inductor selected for the \textit{LC3588-1} circuit}
...
\end{tabular}
\caption{Inductor selected for the \textit{ADP5091} circuit}
...
\end{tabular}
\caption{Capacitors selected for the \textit{ADP5091} circuit}
...
\end{tabular}
\caption{Rectifier diodes selected for the \textit{ADP5091} circuit}
