...
An important part of the evaluation process is to provide proper load conditions for the harvester. By doing that, it is possible to find the maximum power point where the power source impedance matches the load, according to the maximum power transfer theorem.
