...
\begin{figure}[ht!]
\includegraphics[scale=0.8]{sallenresponse.pdf}
...
The testing process consists of a few steps. The first one is to control all voltage rails to verify their performance. Subsequently, the reference voltage source has been checked. The next step is to validate relay operation, button and switches operation as well as LED indicators.
\par
...
Calibration is the last step required to finish the design of the logger board.
...
\begin{figure}[ht!]
\includegraphics[scale=0.75]{timedomain.pdf}
