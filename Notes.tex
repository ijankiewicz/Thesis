...
\par
The most common mechanical constitutive equation is known as Hooke's Law -see Equation \ref{eqn:hooke} \cite{piezomath}. 
\begin{equation}
...
Since the electrical properties also need to be taken into account, a constitutive equation for common dielectrics is introduced.
...
\end{conditions}
Both of above-mentioned constitutive equations are now combined to create one coupled equation. This way, providing that mechanical properties of the piezoelectric material are known, it is possible to describe or model the harvester.
\begin{equation}
\label{coupled}
\begin{aligned}
