...
% dot instead of colon in figure descriptions
...
\lstdefinestyle{mystyle}{
    ...
    basicstyle=\fontsize{1}{12}\selectfont\ttfamily,
...
\par
Power generation of the energy harvester is mostly depend on the input impedance of the DC converter, as it should match the impedance of the piezoelectric harvester output in order to maintain maximum efficiency of energy generation \cite{EnHv2}. In case of presented designs, their input impedance depends mostly on the input capacitor and its actual charge. In order to to keep the input impedance on a similar level, one should assume that the capacitor has been charged before the the load has been supplied with the power.
...
\lstinputlisting[language=Octave]{dataConvert.m}


\includepdf[pages=1,angle=90,scale=0.85,pagecommand=\section{Harvester board schematics}, offset=0 -1cm]{Harvester_board.pdf}
\includepdf[pages=2-,angle=90,scale=0.85,pagecommand={}, offset=0 -1cm]{Harvester_board.pdf}
%\includepdf[pages=-,angle=90, pagecommand=\thispagestyle{plain}]{Harvester_board.pdf}

\includepdf[pages=1,angle=90,scale=0.85,pagecommand=\section{Data acquisition board schematics}, offset=0 -1cm]{Logger2_beta.pdf}
\includepdf[pages=2-,angle=90,scale=0.85,pagecommand={}, offset=0 -1cm]{Logger2_beta.pdf}
%\includepdf[pages=-,angle=90, pagecommand=\thispagestyle{plain}]{Logger2_beta.pdf}

\includepdf[pages=1,angle=90,scale=0.85,pagecommand=\section{Accelerometer board schematics}, offset=0 -1cm]{Accelerometer_board.pdf}
\includepdf[pages=2-,angle=90,scale=0.85,pagecommand={}, offset=0 -1cm]{Accelerometer_board.pdf}
%\includepdf[pages=-,angle=90, pagecommand=\thispagestyle{plain}]{Accelerometer_board.pdf}
