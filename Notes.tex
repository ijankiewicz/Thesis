...
\begin{equation}
    V_{error} = (R_{ser} \cdot (I_{bias} + I_{leak1} +  I_{leak2})) \cdot A_u = (1k\Omega \cdot (250pA + 20nA + 20nA))\cdot 1 = 40.25\mu V
    \label{bias_calculated}
\end{equation}
