...
\begin{titlepage}
    \centering
    \includegraphics[width=6cm]{logo.jpg} % also works with 
    \vskip1cm
    {\Large
...
\begin{titlepage}
    \centering
    \includegraphics[width=6.5cm]{logo2.png} % also works with 
    \vskip1cm
    {\Large
        POLITECHNIKA ŚLĄSKA\\
        WYDZIAŁ ELEKTRYCZNY\\
...
\subsubsection{Nanopower Buck-Boost DC/DC with Energy Harvesting Battery Charger - LTC3331}
...
\subsubsection{Ultralow Power Energy Harvester PMU with MPPT and Charge Management - ADP5091}
